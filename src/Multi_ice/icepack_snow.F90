...
! thickness does not
      ...
      subroutine snow_redist(dt, nslyr, ncat, wind, ain, vin, vsn, zqsn, &
         alvl, vlvl, fresh, fhocn, hocnn,fsloss, rhos_cmpn, fsnow)
      ...
      do n = 1, ncat
         ...
         do k = 1, nslyr
            ...
            tmp3n(n) = tmp3n(n) + vsn(n)*zqsn(k,n)/nslyr
         enddo
      enddo
...
!         write(warning,*)'lost',suma,flost,alost,msnw_susp
      ...
      do n = 1, ncat
         do k = 1, nslyr
            ...
            tmp4n(n) = tmp4n(n) + vsn(n)*zqsn(k,n)/nslyr
         enddo
      ...
      do n = 1, ncat
         hocnn(n+1)=hocnn(n+1) + (tmp3n(n)-tmp4n(n)) / dt
      enddo
