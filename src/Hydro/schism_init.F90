...
#ifdef USE_MICE
        allocate(tau_oi(2,npa),wave_spec(npa,30),wave_spec1(npa,30),wave_spec2(npa,30),fresh_wa_flux(npa),net_heat_flux(npa), &
...
!     Initialize some arrays and constants
      tempmin=-5.d0; tempmax=50.d0; saltmin=0.d0; saltmax=42.d0
