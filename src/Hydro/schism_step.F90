...
#ifdef USE_MICE
          call get_wave_spec(wtime2, wave_spec2)
#endif
#endif
        endif !time>=wtime2
...
!$OMP parallel do default(shared) private(i)
        do i=1,npa
          ...
          pr(i)=pr1(i)+wtratio*(pr2(i)-pr1(i))
#ifdef USE_MICE
          wave_spec(i,:)=wave_spec1(i,:)+wtratio*(wave_spec2(i,:)-wave_spec1(i,:))
          if((it-iths_main)<864.d0) then
            wave_spec(i,:)=0.d0
          endif
#endif
        enddo !i
